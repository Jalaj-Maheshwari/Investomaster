...
import com.android.App_25.data.Contract;
import com.android.App_25.data.PrefUtils;
import com.android.App_25.utils.BasicUtils;
...
public final class QuoteSyncJob {
    ...
    public static final String ACTION_DATA_UPDATED = "com.android.App_25.ACTION_DATA_UPDATED";
    ...
    public static void getQuotes(Context context) {
        ...
        try {
            ...
            Set<String> stockPref = PrefUtils.getStocks(context); // returns default stocks
            ...
            Map<String, Stock> quotes = YahooFinance.get(stockArray); // key value pair is attached.
            Iterator<String> iterator = stockCopy.iterator(); // iteration over default stocks
    ...
    private static void schedulePeriodic(Context context) {
        ...
        JobInfo.Builder builder = new JobInfo.Builder(PERIODIC_ID, new ComponentName(context, com.android.App_25.sync.QuoteJobService.class));
    ...
    synchronized public static void syncImmediately(Context context) {
        ...
        if (BasicUtils.isNetworkUp(context)) {
            Intent nowIntent = new Intent(context, com.android.App_25.sync.QuoteIntentService.class);
            context.startService(nowIntent);
        } else {
            JobInfo.Builder builder = new JobInfo.Builder(ONE_OFF_ID, new ComponentName(context, com.android.App_25.sync.QuoteJobService.class));
            builder.setRequiredNetworkType(JobInfo.NETWORK_TYPE_ANY)
                    .setBackoffCriteria(INITIAL_BACKOFF, JobInfo.BACKOFF_POLICY_EXPONENTIAL);
            JobScheduler scheduler = (JobScheduler) context.getSystemService(Context.JOB_SCHEDULER_SERVICE);
            scheduler.schedule(builder.build());
